...
public class RegistrationController {
     ...
     */
    @Autowired
    public RegistrationController(UserService userService , ResourceLoader resourceLoader) {
     ...
     */
   @GetMapping
    public ResponseEntity<Resource> getRegistrationPage(@RequestParam(name = "error", required = false) String error) {
        Resource resource = resourceLoader.getResource("classpath:/static/register_page.html");
