...
public class UserService {
    ...
    public boolean authenticate(String username, String password) throws SQLException {
        ...
        // replace.
        final String sql = "select * from Operator where UserName = ?";
    ...
    public boolean registerUser(String username, String password, String firstName, String lastName)
        ...
        // above.
        final String registerSql = "insert into Operator (UserName, Password, FirstName, LastName) values (?, ?, ?, ?)";
    ...
    /**
     * Write an SQL query to get the user by user id.
     *
     * @param userId the user id to search for
     * @return the User object corresponding to the user id, or null if not found
    ...
    public User getUserById(String userId) throws SQLException {
        ...
        // Write an SQL query to get the user by user id.
        final String sql = "select FirstName , LastName from Operator where Employeeid = ?";
